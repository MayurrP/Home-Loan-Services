...
import com.app.pojo.PropertyInfo;
...
//	}
	//@RequestPart
	//This annotation associates a part of a multipart request with the method argument, 
	//which is useful for sending complex multi-attribute data as payload, 
